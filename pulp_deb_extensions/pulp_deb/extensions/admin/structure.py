...
DESC_ROOT = _('manage Deb-related content and features')
DESC_REPO = _('repository lifecycle commands')

DESC_REMOVE = _('remove copied or uploaded debs from a repository')
DESC_UPLOADS = _('upload debs into a repository')
...
def ensure_repo_structure(cli):
    ...
    # Make sure the deb root is in place
    root_section = ensure_deb_root(cli)
